...
export const studyProgress = (params = {}) => {
  return http().post('/course/user/study/progress', params)
}
...
// 手动支付成功
export const paySuccess = (type, orderNo, flag) => {
  return http().post('/user/api/order/pay/notify?payModel=' + flag + '&payImpl=' + type + '&tradeOrderNo=' + orderNo)
}
