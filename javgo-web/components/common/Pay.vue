  ...
  <div class="">
    ...
    <div v-if="payStep === 1" class="paymodal codemodal">
      ...
      <div class="modal_body">
        ...
        <p v-else class="tip2">请使用微信扫描<br> 二维码以完成订单
          <button class="pay_success" style="margin-top:15px" @click="paySuccessSubmit(order.payType,orderInfo.serialNumber,0)">
            支付完成！
          </button>
        </p>
        <br>
...
<script>
import { createOrder, orderInfoView, paySuccess } from '@/api/course.js'
...
export default {
  ...
  methods: {
    ...
    paySuccessSubmit(type, orderNo, flag) {
      console.log(type)
      console.log(orderNo)
      console.log(flag)
      paySuccess(type, orderNo, flag).then(res => {
        console.log(res)
      })
    }
  }
