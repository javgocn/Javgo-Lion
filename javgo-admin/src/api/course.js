...
// 专区讲师修改
export function zoneTeacherSave(data) {
  return request.post('/course/admin/zone/teacher/save', data)
}

// 专区讲师保存
export function zoneTeacherList(data) {
  return request.get('/course/admin/zone/teacher/list', data)
}

// 专区讲师修改
export function zoneTeacherDelete(data) {
  return request.post('/course/admin/zone/teacher/delete', data)
}

// 专区讲师修改
export function zoneTeacherUpdate(data) {
  return request.post('/course/admin/zone/teacher/update', data)
}
