<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      <a href="http://localhost:3000" target="_blank" class="nav-item">前端首页</a><span>&nbsp;&nbsp;|</span>
      <el-dropdown class="avatar-container" size="medium" @command="commandFn" trigger="hover" style="margin-top: 8px">
