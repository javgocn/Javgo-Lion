<template>
  <div class="login-layout">
    <div class="container">
      <img alt class="login-logo2" src="../../assets/images/login-logo.jpg" style="width: 54.8%;height: 100%"/>
      <div class="login-panel">
        <div class="head clearfix">
          <div class="logo">
            <img v-if="service.websiteLogo" :src="service.websiteLogo"/>
            <img v-else class="img-logo" src="../../assets/logo_logo.png"/>
          </div>
        </div>
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" auto-complete="on" label-position="left">
          <h3 class="login-head">管理员登录</h3>
          <el-form-item class="form-group" prop="mobile">
            <el-input ref="mobile" v-model="loginForm.mobile" auto-complete="on" class="form-input" name="mobile"
                      placeholder="用户名" tabindex="1" type="text" @keyup.enter="handleLogin"/>
          </el-form-item>
          <el-form-item class="form-group" prop="mobilePwd">
            <el-input ref="mobilePwd" v-model="loginForm.mobilePwd" :type="mobilePwdType" auto-complete="on" class="form-input"
                      name="mobilePwd" placeholder="密码" tabindex="2" @keyup.enter="handleLogin"/>
          </el-form-item>
          <el-form-item v-if="loginForm.imageVerificationToken" prop="imageVerificationToken" hidden>
            <div class="flex_code">
              <el-input v-model="loginForm.imageVerificationToken" class="flex_code_input"/>
            </div>
          </el-form-item>
          <el-form-item v-if="loginForm.imageVerificationToken" prop="imageVerification">
            <div class="flex_code">
